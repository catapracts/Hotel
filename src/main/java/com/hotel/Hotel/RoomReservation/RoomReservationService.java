...
public class RoomReservationService 
{
	...
	public void timeAndRoomDuplicate(Member member, int rid, Date sdate, Date edate) 
	{
		...
		for (int i = 202; i <= 205; i++) 
		{
			...
			if (
					(roomReservation.getSdate().equals(t1))
					&& (roomReservation.getEdate().equals(t2))
	...
	// 예약 생성
	public RoomReservation createRoomReservation(Member member, int rid, 
			Date sdate, Date edate, int cnt) 
	{
